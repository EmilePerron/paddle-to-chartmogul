 ...
 */
final class Version20220116014553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__customer AS SELECT id, paddle_id, email, chart_mogul_id, last_sync_date FROM customer');
        ...
        $this->addSql('INSERT INTO customer (id, paddle_id, email, chart_mogul_id, last_sync_date) SELECT id, paddle_id, email, chart_mogul_id, last_sync_date FROM __temp__customer');
