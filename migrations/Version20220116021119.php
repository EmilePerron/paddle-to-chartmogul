 ...
 */
final class Version20220116021119 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__subscription AS SELECT id, plan_id, customer_id, owner_id, paddle_id, state, sign_up_date, quantity, chart_mogul_id, last_sync_date, next_payment_date FROM subscription');
        ...
        $this->addSql('INSERT INTO subscription (id, plan_id, customer_id, owner_id, paddle_id, state, sign_up_date, quantity, chart_mogul_id, last_sync_date, next_payment_date) SELECT id, plan_id, customer_id, owner_id, paddle_id, state, sign_up_date, quantity, chart_mogul_id, last_sync_date, next_payment_date FROM __temp__subscription');
